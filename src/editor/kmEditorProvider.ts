    ...
    <div class="app">
      ...
      <div class="toolbar">
        ...
        <div class="toolbar-group">
          ...
          <button id="btn-zoom-readable" class="btn icon-btn" title="可读视图 (⌘1)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3"/><path d="M21 8V5a2 2 0 0 0-2-2h-3"/><path d="M3 16v3a2 2 0 0 0 2 2h3"/><path d="M16 21h3a2 2 0 0 0 2-2v-3"/><path d="M8 10h8"/><path d="M8 14h6"/></svg></button>
